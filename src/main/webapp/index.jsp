...
<body>
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal">
                        	<div class="form-group">
                                <label for="input0" class="col-sm-2 control-label">名称</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="input0" placeholder="名称">
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function loadRate() {
        	...
        	if($("#input0").val() == "" || $("#input1").val() == ""  || $("#input2").val() == "" || $("#input3").val() == "" || $("#input4").val() == "" || $("#input5").val() == "" || $("#input6").val() == "" || $("#input7").val() == ""){
